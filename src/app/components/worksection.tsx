        ...
        <Container >
            ...
            <Row>
                <Col md={4} className="mb-3">
                    <Card>
                        <Card.Img variant="top" src="/images/section_01.jpg"></Card.Img>
                        <Card.Body>
                            <Card.Title>
                ...
                <Col md={4} className="mb-3">
                    <Card>
                        <Card.Img variant="top" src="/images/section_02.jpg"></Card.Img>
                        <Card.Body>
                            <Card.Title>
                                Rice with wild boar liver and cutted chese form texas
                            </Card.Title>
                ...
                <Col md={4} className="mb-3">
                    <Card>
                        <Card.Img variant="top" src="/images/section_03.jpg"></Card.Img>
                        <Card.Body>
                            <Card.Title>
                                Rice with wild boar liver and cutted chese form texas
                            </Card.Title>
